<template>
  <div id="container" class="container">
    ...
    <div style="position: absolute; top: 30px; left: 30px">
      <img width="70" height="90"  src="file:///C:/Users/PC/Desktop/1x/7797864.png" alt="">
      <span style="font-family: Garamond, serif;font-weight: 700; font-size: 30px; color: #f8f8f8; text-transform: uppercase; letter-spacing: 5px">mirzad </span>
    </div>
    <div class="avatars">
